...
> [!NOTE]
> **最新一期：** TE 2026-08-22：当信号变成目标，制度就会忘记真正要解决什么 — [English](https://blog.evanzhou.org/en/posts/te-2026-08-22) | [中文](https://blog.evanzhou.org/zh/posts/te-2026-08-22)
>
> 从 AI 意识、数据中心预测，到中国失业率、股票指数、贸易路线和霍尔木兹海峡，本期讨论：当代理指标被当成目标时，它们如何遮蔽真实结果，并整理了 10 个值得掌握的英文表达。
>
