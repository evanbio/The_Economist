...
> [!NOTE]
> **最新一期：** TE 2026-08-15：拥有控制权，不等于拥有行动能力 — [English](https://blog.evanzhou.org/en/posts/te-2026-08-15) | [中文](https://blog.evanzhou.org/zh/posts/te-2026-08-15)
>
> 这一期从阿富汗、委内瑞拉与总统关税权，到中国石油储备、台湾政治僵局、AI 代理和胚胎筛选，区分了可见的控制与把权力转化为持久结果的制度能力，并整理了 10 个值得掌握的英文表达。
>
> **更新时间：** 2026 年 8 月 16 日

---

## 📖 关于 TE Weekly

**TE Weekly** 围绕每期《经济学人》发布整期评论，并不定期精读其中值得深入讨论的文章与观点。
...
栏目的主体。每期围绕一个核心判断展开，用若干相互关联的主题组织材料，而不是沿着目录逐篇介绍。

### 作者精读

不定期发布的单篇文章或单一议题精读。它独立于每周节奏，也可以在某个话题值得重新思考时回到旧期。

### 语言 Roundup

每季度整理近期最值得复用的表达。分类依据不是孤立的中文释义，而是它们在论证中承担的功能。
...
- **一节保留意见**，追问杂志的框架遗漏了什么
- **四件值得观察的事**，留给未来发展验证
- **八至十二个表达**，包含含义、语气、原创例句与使用提示
- **一段完整论证**，展示多个表达如何在真实段落中配合使用

Review 使用中性编辑口吻；作者精读则保留更多个人视角。

---

## 🗓️ 发布节奏

《经济学人》周五出刊，TE Weekly 通常在周末整理、周日发布。

更新节奏保持弹性：可以偶尔缺期，作者精读也可以随时发布。Review 提供中英文版本，通过 Notion 发布到 **Cell by Cell**。
...
[CC BY-NC-SA 4.0](LICENSE) — 允许在署名、非商业使用并以相同方式共享的前提下转载与改编。
